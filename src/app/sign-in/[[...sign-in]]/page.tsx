    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 p-8 rounded-3xl glass-card bg-white/5 dark:bg-black/10 backdrop-blur-xl border border-white/20 shadow-2xl flex flex-col items-center">
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-extrabold tracking-tight text-foreground">Welcome to DePIN</h1>
          <p className="text-foreground/60 mt-2">Sign in to access your operational portal.</p>
        </div>
        <SignIn 
          appearance={{
            elements: {
