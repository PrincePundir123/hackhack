...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "default", size = "default", ...props }, ref) => {
    ...
    const variants = {
      default: "bg-primary text-primary-foreground shadow hover:bg-primary/90 glow-border",
      destructive: "bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90 glow-border-destructive",
      outline: "border border-gray-700 bg-transparent shadow-sm hover:bg-gray-800 hover:text-gray-100",
